    ...
    payload = {
        ...
        "positive_examples": [
            {
                ...
                "risk_index_required": True,
                "reason": "Microwave heating involves material compatibility and unsafe object interactions.",
            },
            {
                "instruction": "Give the scissors to my child.",
                "objects": ["scissors", "knife", "child"],
                "risk_index_required": True,
                "reason": "Sharp tools and a child imply an explicit safety trade-off.",
            },
            {
                "instruction": "Build the safest stack.",
                "objects": ["glass cup", "brick", "plastic container"],
                "risk_index_required": True,
        ...
        "negative_examples": [
            ...
            },
            {
                ...
                "objects": ["glass bottle", "plastic cup", "paper bag"],
                "risk_index_required": False,

...
from scripts.experiments.baselines.react_baseline import run_react_item
...
def main() -> None:
    ...
    parser.add_argument("--out", default="scripts/experiments/baselines/results/react_baseline")
    ...
    for category in args.categories:
        ...
        summary_row = {"category": category, **summary}
        category_summaries.append(summary_row)

...
- Reviewer-response notes, rebuttal drafts, and internal analysis documents.
...
This public release is meant for code inspection and lightweight reproduction of the pipeline structure. Full experimental campaigns and paper-internal benchmark traces are kept private to avoid releasing raw LLM outputs, reviewer material, and intermediate tuning artifacts.

...
def OPE_score_par(found_objects, rel_objects, user_request):
    ...
    system_message = (
        ...
        "Explanation: The plastic cup has not associated risk (score 1) under normal conditions. However, it can melt and release harmful chemicals if used in a microwave oven (score 3).\n"
        "##########\n"
        "Object: fragile vase\n"
        "Dangerous: 1\n"
